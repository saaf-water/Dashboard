...
const waterSummary = [
  {
    type: "Worse",
    boilParam: "Unfit for consumption",
    altUse: "Water suitable for external use only!",
  },
  {
    type: "Bad",
    boilParam:
      "RO filteration and good boiling / UV filteration required before cosumption",
    altUse: "Water suitable for domestic usage",
  },
  {
    type: "Good",
    boilParam:
      "Sedementary filteration followed by good boiling required before cosumption",
    altUse: "Water suitable for domestic usage",
  },
  {
    type: "Very Good",
    boilParam: "Boiling required before cosumption",
    altUse: "Water suitable for direct domestic usage",
  },
];
      ...
      return (
        <>
          <div className="bg-gradient-to-br from-red-500 to-pink-300 dark:from-red-600 dark:to-pink-400 h-96 rounded-xl">
            <div className="p-4">
              <div className="justify-self-start font-roboto-semibold text-white text-xl py-5">
                Water Quality Summary{" "}
              </div>
              <div className="justify-self-start content-center font-roboto font-extrabold text-white text-6xl pb-5">
                {waterSummary[current.summary].type}
              </div>
              <div className="justify-self-start text-black-900 font-bold p-2">
                + {waterSummary[current.summary].boilParam}
              </div>
              <div className="justify-self-start text-black-900 font-bold p-2">
                + {waterSummary[current.summary].altUse}
              </div>
            </div>
          </div>
        </>
      );
    } else if (current.summary === 1) {
      return (
